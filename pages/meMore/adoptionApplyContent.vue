<template>
	<view class="page">
		<PawPageNav title="申请内容" fallback-url="/pages/meMore/adoptionDetail" :auto-back="false" @back="goBack" />
...
<script>
import { getAdoptionById, getDemoAdoptions, getLastAdoptionId } from '@/utils/adoptionStorage.js'
import { adoptionPetAvatarSrc } from '@/utils/adoptionPetDisplay.js'
import YardTagPill from '@/components/YardTagPill.vue'
import PawPageNav from '@/components/PawPageNav.vue'

export default {
	components: { YardTagPill, PawPageNav },
	data() {
		return {
			recordId: '',
			record: null
