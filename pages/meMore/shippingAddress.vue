...
.footer-btn text { font-size: 30rpx; font-weight: 600; line-height: 42rpx; }
...
.footer-plus { margin-right: 8rpx; font-size: 36rpx; font-weight: 600; line-height: 1; }
...
.delete-panel-msg { display: block; text-align: center; font-size: 32rpx; font-weight: 600; color: #222; line-height: 48rpx; }
...
.delete-btn text { font-size: 30rpx; font-weight: 600; color: #111; line-height: 42rpx; }
.delete-btn--cancel { background: #f2f2f2; }
.delete-btn--cancel text { color: #333; font-weight: 500; }
.delete-btn--danger { background: #ffe60f; }
.nav-title{display:none!important}.page-heading{height:44px;padding:0 15px;display:flex;align-items:center;font-size:17px;font-weight:600;color:#222;box-sizing:border-box}
