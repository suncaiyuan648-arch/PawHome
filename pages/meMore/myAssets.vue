...
.assets-page--new{min-height:812px;padding-top:44px;background:#eaf5ff}.new-nav{height:54px;display:flex;align-items:center;padding-right:9px;box-sizing:border-box}.new-nav>text{font-size:18px;font-weight: 500}.rules{margin-left:auto;padding:5px 11px;border-radius:14px;background:#c9d9ea;color:#6f8194;font-size:12px}.new-medal-card{position:absolute;left:24px;right:24px;top:121px;bottom:0;display:flex;flex-direction:column;align-items:center;background:#fff;border-radius:24px 24px 0 0}.new-medal-image{width:164px;height:164px;margin-top:70px;border-radius:50%}.new-medal-name{margin-top:26px;font-size:20px;font-weight:700}.new-medal-state{margin-top:3px;color:#666;font-size:16px}.new-medal-sub{margin-top:5px;color:#aaa;font-size:13px}.progress-row{position:relative;width:274px;height:20px;margin-top:48px}.progress-fill{position:absolute;left:0;right:0;top:9px;height:5px;border-radius:4px;background:#1639bf}.progress-check{position:absolute;right:-4px;top:0;width:19px;height:19px;border:2px solid #1639bf;border-radius:50%;display:flex;align-items:center;justify-content:center;background:#fff;color:#1639bf;font-size:14px;font-weight:700;box-sizing:border-box}.task-state{margin-top:2px;color:#aaa;font-size:13px}.encouragement{margin-top:52px;color:#b7b7b7;font-size:14px}.claim-button{width:201px;height:49px;margin-top:16px;border-radius:25px;display:flex;align-items:center;justify-content:center;background:linear-gradient(90deg,#f6e0aa,#e9ca76);color:transparent;font-size:15px}
