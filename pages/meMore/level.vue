			...
			<view class="scroll-inner">
				...
				<view class="menu-card">
					<view
						...
						:key="i"
						class="menu-row"
						:class="{ 'menu-row--last': i === menuRows.length - 1 }"
						@click="onMenu(row)"
					>
...
<script>
	...
	export default {
		...
		computed: {
			...
			levelTitle() {
				const t = LEVEL_TITLES[this.userLevel]
				return t || LEVEL_TITLES[this.maxLevel]
			},
			progressPercent() {
...
<style scoped>
	...
	.level-top-reference { position: absolute; left: 0; top: 0; width: 100%; height: 100px; z-index: 20; pointer-events: none; }
	...
	.stat-col:last-child .stat-val { width: 100rpx; }
