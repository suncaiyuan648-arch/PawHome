<template>
  <view class="login-page paw-page">
    ...
    <view class="login-actions paw-safe-bottom">
      <PawPrimaryButton variant="wechat" @click="onWechatLogin"><uni-icons type="weixin" color="#ffffff"
          :size="18" /><text class="button-icon-label">微信登录</text></PawPrimaryButton>
      <view class="action-gap" />
      <PawPrimaryButton variant="secondary" @click="onPhoneLogin"><uni-icons type="phone" color="#333333"
          :size="17" /><text class="button-icon-label">手机号登录</text></PawPrimaryButton>
