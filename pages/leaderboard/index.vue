...
function cloneBoard(payload) {
	const podiumAvatar = '/static/figma/leaderboard/avatar-xiangzi-original.png'
	const podiumAvatars = [
		podiumAvatar,
		podiumAvatar,
		podiumAvatar
	...
	return {
		topThree: payload.topThree.map((x, index) => ({
			...x,
			avatar: x.avatar || podiumAvatars[index]
		})),
...
const TAB_BOARD = {
	day_feed: {
		topThree: [
			{ name: '项子涵', lv: 1, weight: '499', city: '长沙', avatar: '/static/figma/leaderboard/avatar-xiangzi-original.png' },
			{ name: '项子涵大王', lv: 1, weight: '499', city: '长沙', avatar: '/static/figma/leaderboard/avatar-xiangzi-original.png' },
			{ name: '平头大王', lv: 1, weight: '499', city: '长沙', avatar: '/static/figma/leaderboard/avatar-xiangzi-original.png' }
		],
		rankList: [
			...
			{ rank: 10, name: '项子涵186..', lv: 1, weight: '499', city: '长沙', avatar: '/static/figma/feature/bf6cfd188d6671b8e283e5e5563ece9da7dc2ef8.jpg' }
		],
