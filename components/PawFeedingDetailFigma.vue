<template>
  <view class="fd-page" :class="{ 'fd-page--pet': variant === 92 }">
    <view class="fd-top">
      ...
      <view class="fd-nav"><image src="/static/nav-back-arrow.png" mode="aspectFit"/><text>投粮详情</text><view class="fd-menu"><uni-icons type="more-filled" color="#333" :size="18"/><view class="menu-separator"/><uni-icons type="circle-filled" color="#111" :size="14"/></view></view>
    </view>
...
export default {
  ...
  data() {
    ...
    return { feedImgs, avatarImgs: feedImgs.slice(0,4), photoImgs: feedImgs.slice(4,7), logs:['已签收','已发货','仓库分拣打包中','已下单'] }
  },
}
</script>

<style scoped>
.fd-page{position:relative;min-height:100vh;background:#fff;color:#333;font-size:13px}.fd-top{height:99px;background:#fff574}.fd-status{height:36px;padding:11px 16px 0 34px;box-sizing:border-box;display:flex;justify-content:space-between;font-size:15px;font-weight:600;color:#111}.fd-status-icons{display:flex;align-items:center;gap:6px}.fd-nav{height:63px;position:relative;display:flex;align-items:center;justify-content:center}.fd-nav>image{position:absolute;left:16px;width:10px;height:18px}.fd-nav>text{font-size:16px;font-weight:600;color:#222}.fd-menu{position:absolute;right:8px;width:78px;height:30px;border:1px solid rgba(0,0,0,.08);border-radius:16px;display:flex;align-items:center;justify-content:center;gap:7px;color:#333}.menu-separator{width:1px;height:18px;background:rgba(0,0,0,.1)}.order-summary{height:150px;padding:23px 17px 0;box-sizing:border-box}.order-main{display:flex;align-items:flex-start}.order-avatar{width:35px;height:35px;border-radius:50%;flex:none}.order-copy{margin-left:8px;display:flex;flex-direction:column}.order-name{font-size:14px}.yard-pill{margin-left:4px;padding:1px 5px;border-radius:4px;background:#ffe646;font-size:9px}.order-amount{margin-top:3px;font-size:14px}.order-time{margin-top:6px;font-size:12px;color:#999}.order-right{margin-left:auto;display:flex;flex-direction:column;align-items:flex-end}.timeout{height:24px;font-size:12px;color:#ff334b}.progress{font-size:11px;color:#52637c;background:#f0f3f8;padding:3px 7px}.order-number{margin:8px 0 0 42px;font-size:12px;color:#0875dc}.waiting{margin:10px 0 0 42px;font-size:11px;color:#ff394a}.waiting>text{border:1px solid #ff394a;border-radius:4px;padding:2px 5px}.timeline{padding:0 15px 78px;box-sizing:border-box}.timeline-row{display:flex;min-height:207px}.axis{width:18px;display:flex;flex-direction:column;align-items:center}.dot,.log-dot{width:8px;height:8px;border-radius:50%;background:#ffe100;border:1px solid #ddd;box-sizing:border-box}.line{width:1px;flex:1;background:#e6e6e6}.row-body{flex:1;padding:0 0 15px 1px}.row-head{display:flex;justify-content:space-between;align-items:center}.row-head text:first-child{font-size:27px;font-weight:600;color:#3d3d3d}.row-head text:last-child{font-size:15px}.avatars{display:flex;gap:4px;margin-top:9px}.avatars image{width:32px;height:32px;border-radius:50%}.row-text{display:block;margin-top:7px;font-size:13px}.photos{display:flex;gap:7px;margin-top:10px}.photos image{width:57px;height:57px;border-radius:5px}.view-link{display:block;margin-top:3px;font-size:11px;color:#296698}.log-row{height:40px;display:grid;grid-template-columns:18px 1fr auto;align-items:center}.log-row text:last-child{font-size:11px;color:#999}.feedback{position:fixed;right:14px;bottom:15px;width:90px;height:38px;border-radius:20px;background:#ffe000;display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:600}.pet-summary{height:475px;padding:31px 20px 0;background:#fff;box-sizing:border-box;position:relative}.pet-photo{width:95px;height:95px;border-radius:5px}.pet-copy{position:absolute;left:125px;right:16px;top:28px}.pet-title{display:flex;align-items:center;gap:5px}.pet-title>text:first-child{font-size:17px}.green,.brown{padding:2px 5px;border-radius:4px;font-size:10px}.green{background:#8fd84f}.brown{background:#bc8648;color:#fff}.pet-desc{display:block;margin-top:4px;font-size:13px;line-height:18px;color:#777}.pet-tags{display:flex;gap:5px;margin-top:8px}.pet-tags text{padding:2px 5px;border-radius:3px;background:#f3f3f3;font-size:10px;color:#777}.pet-tags text:first-child{color:#ff4b2f;background:#fff0e8}.pet-meta{margin-top:12px;display:flex;flex-direction:column;gap:8px;font-size:12px;color:#999}.pet-meta .blue{color:#0875dc}.pet-meta .orange{color:#ff7b26}.timeline--pet{padding-top:0}
