<template>
  <view class="af-page"
    :class="['af-frame-' + frameNumber, { 'af-yellow': yellowTop, 'af-progress-page': progressMode }]">
    <!-- #ifndef MP-WEIXIN -->
    ...
    <view class="af-content">
      <view class="af-heading">
        <PawIcon v-if="frameNumber === 50" class="af-heading-status-image" name="status/check-outline" :size="19" />
        <PawIcon v-else-if="statusCheckAsset" class="af-heading-status-image" name="status/check" :size="19" />
      ...
      <view v-if="progressMode" class="af-progress-card">
        <view class="af-progress-track">
          ...
          <view v-for="step in 4" :key="step" class="af-progress-dot" :class="{ active: step <= progressStep }"
            :style="{ left: progressDotLeft(step) }">
        ...
        <view class="af-progress-labels">
          <text>领养成功</text><text>院主确认</text><text v-if="frameNumber === 56">评审中</text><text
            v-else></text><text>抽取奖励</text>
        </view>
      </view>
      ...
      <template v-if="showAdoptionInfo">
        ...
        <view class="af-card af-contact-card">
          <view class="af-contact-head">
            ...
            <text>芝</text>
            <PawOwnerBadge class="af-contact-owner" /><text class="af-contact-link">联系方式</text><uni-icons type="right"
              color="#aaa" :size="13" />
          </view>
...
export default {
  ...
  components: { PawOwnerBadge, PawIcon },
...
.af-page {
  ...
  min-height: 100vh;
  overflow: hidden;
  background: linear-gradient(180deg, #fffde6 0, #fff 100px, #f5f5f5 180px, #f5f5f5 100%);
  color: #333;
...
.af-page.af-yellow {
  background: linear-gradient(180deg, #fcf276 0, #fcf276 307px, #f5f5f5 307px, #f5f5f5 100%)
}

.af-frame-46.af-yellow,
.af-frame-47.af-yellow {
  background: linear-gradient(180deg, #fcf276 0, #fcf276 279px, #f5f5f5 279px, #f5f5f5 100%)
}

.af-page.af-progress-page {
  background: linear-gradient(180deg, #fffde6 0, #fff 100px, #f5f5f5 180px, #f5f5f5 100%)
}

.af-statusbar-reference {
  position: absolute;
  left: 0;
  top: 0;
  width: 100%;
...
.af-location-card>view {
  display: flex;
  align-items: center;
  gap: 3px
}

.af-location-card>text {
  margin-left: 9px
}

.af-location-card .af-distance {
  position: absolute;
  right: 16px;
  color: #777
}
...
.af-contact-head .af-contact-link {
  position: absolute;
  right: 17px;
  font-size: 13px;
  color: #888
...
.af-proof-photos>view {
  width: 106px;
  text-align: center
}

.af-proof-photos image {
  display: block;
  width: 106px;
  height: 106px;
  border-radius: 3px
...
.af-progress-labels text:nth-child(1) {
  left: 3px
}
...
.af-progress-labels text:nth-child(4) {
  right: 6px
}
...
.af-frame-48 .af-statusbar-reference,
.af-frame-50 .af-statusbar-reference,
.af-frame-54 .af-statusbar-reference {
  height: 130px
}
...
.af-frame-44 .af-content,
.af-frame-45 .af-content {
  padding-bottom: 15px
}

.af-frame-46 .af-heading,
.af-frame-47 .af-heading {
  height: 71px
}

.af-frame-48 .af-heading,
.af-frame-49 .af-heading {
  display: none
}

.af-frame-48 .af-content,
.af-frame-49 .af-content {
  padding-top: 12px
}

.af-frame-49 .af-apply-card {
  margin-bottom: 10px
}

.af-frame-50 .af-heading,
.af-frame-51 .af-heading,
.af-frame-52 .af-heading,
.af-frame-53 .af-heading,
.af-frame-54 .af-heading,
.af-frame-55 .af-heading,
.af-frame-56 .af-heading,
.af-frame-57 .af-heading {
  height: 81px
}

.af-frame-50 .af-content,
.af-frame-54 .af-content {
  padding-bottom: 14px
}

.af-frame-50 .af-location-card,
.af-frame-54 .af-location-card {
  margin-top: 10px
}

.af-frame-51 .af-proof-card,
.af-frame-52 .af-proof-card,
.af-frame-53 .af-proof-card {
  margin-top: 0
}

.af-frame-52 .af-pets-card,
.af-frame-53 .af-pets-card {
  margin-top: 10px
}

.af-frame-55 .af-content,
.af-frame-56 .af-content,
.af-frame-57 .af-content {
  padding-bottom: 0
}

.af-frame-55 .af-proof-card,
.af-frame-56 .af-proof-card,
.af-frame-57 .af-proof-card {
  margin-top: 0
}

.af-frame-55 .af-progress-fill {
  width: 6% !important
}

.af-frame-56 .af-progress-fill {
  width: 29% !important
}

.af-frame-57 .af-progress-fill {
  width: 84% !important
}

.af-frame-55 .af-progress-dot:nth-of-type(2),
.af-frame-56 .af-progress-dot:nth-of-type(2),
.af-frame-57 .af-progress-dot:nth-of-type(2) {
  left: 3% !important
}

.af-frame-55 .af-progress-dot:nth-of-type(3),
.af-frame-56 .af-progress-dot:nth-of-type(3),
.af-frame-57 .af-progress-dot:nth-of-type(3) {
  left: 26% !important
}

.af-frame-55 .af-progress-dot:nth-of-type(4),
.af-frame-56 .af-progress-dot:nth-of-type(4),
.af-frame-57 .af-progress-dot:nth-of-type(4) {
  left: 58% !important
}

.af-frame-55 .af-progress-dot:nth-of-type(5),
.af-frame-56 .af-progress-dot:nth-of-type(5),
.af-frame-57 .af-progress-dot:nth-of-type(5) {
  left: 84% !important
}

.af-progress-page .af-link-row:last-child {
  margin-bottom: 0
}

.af-page .af-heading text {
  font-weight: 700
}

.af-page .af-contact-head,
.af-page .af-contact-copy {
  transform: none
}
...
.af-frame-48 .af-contact-head,
.af-frame-48 .af-contact-copy {
  transform: translateY(2px)
}
