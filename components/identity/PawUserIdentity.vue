...
.paw-user-identity--block { display: flex; width: 100%; align-items: flex-start; box-sizing: border-box; }
...
.paw-user-identity__badge-hit { display: inline-flex; align-items: center; flex-shrink: 0; }
